...
export class PopupService {
  ...
  makeCapitalPopup(data: any): any {
    ...
    return `
   <div>
    <div class="desc" style="color: #FD784F;font-size: 1.5em;font-weight: bold;">${data.description}</div>
    <div class="square">Diện tích: ${ data.square }m<sup>2</sup></div>
    <div class="cost">Giá: ${data.cost}</div>
    <div class="kind">Loại: ${data.kind}</div>
    <img src="${data.img}" style="max-width:100%; max-height:100%;object-fit: contain"/>
