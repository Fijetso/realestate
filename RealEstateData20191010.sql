...
INSERT INTO `address` VALUES (1,'Số nhà 53',760,79,26749),(2,'Số nhà 201',760,79,26746),(3,'Số nhà 94',762,79,26827),(4,'Số nhà 94',762,79,26806),(5,'Số nhà 94',774,79,27313),(6,'Số nhà 201',774,79,27328);
...
INSERT INTO `confirmation_token` VALUES (10,'81ffaceb-cfaf-4f9d-9fd2-012f619210e6','2019-10-04 08:21:13',9),(11,'dd861e6a-2d88-49ea-9b68-3ff3ac4ba9a6','2019-10-04 08:38:17',9),(13,'57fc2fbb-991f-49fa-9c62-bec02df2c19a','2019-10-04 17:06:23',12);
...
INSERT INTO `favorite_trade` VALUES (1,1);
...
INSERT INTO `hibernate_sequence` VALUES (14),(14),(14),(14),(14),(14),(14),(14),(14),(14),(14),(14),(14),(14);
...
CREATE TABLE `news` (
  `id` bigint(20) NOT NULL,
  `compose_date` datetime DEFAULT NULL,
...
INSERT INTO `real_estate_kind` VALUES (1,'Chung cư'),(2,'Đất nền'),(3,'Nhà riêng');
...
INSERT INTO `real_image` VALUES (1,'Real Estate','https://res.cloudinary.com/fijetso3671/image/upload/v1559034773/RealEstate/maxresdefault_ropnun.jpg',1),(2,'Real Estate','https://res.cloudinary.com/fijetso3671/image/upload/v1559034774/RealEstate/uploads_2Fcard_2Fimage_2F829044_2Ff1a11a98-59ed-46a9-a2df-bf2a6997ee31.jpg_2F950x534__filters_3Aquality_2890_29_eiw5xu.jpg',1),(19,'Mặt trước','http://res.cloudinary.com/fijetso3671/image/upload/v1559860911/RealEstate/kql6ziprexdjjvcqmn1m.webp',2),(20,'Trong nhà','http://res.cloudinary.com/fijetso3671/image/upload/v1559860911/RealEstate/kql6ziprexdjjvcqmn1m.webp',2),(3,'Trong nhà','https://res.cloudinary.com/fijetso3671/image/upload/v1559872643/RealEstate/201810225152_20181025_115002_diaias.jpg',2),(4,'Mặt trước','https://res.cloudinary.com/fijetso3671/image/upload/v1559872755/RealEstate/20160420062223-31ae_okbvke.jpg',3),(5,'Trong nhà','https://res.cloudinary.com/fijetso3671/image/upload/v1559872755/RealEstate/20160803161350-6c53_pjgujr.jpg',3),(6,'Nhà bếp','https://lacan.vn/wp-content/uploads/2016/06/10-mau-tu-bep-chu-l-dep-nhat-hien-nay-m5.jpg',3),(7,'Mặt trước','https://res.cloudinary.com/fijetso3671/image/upload/v1559873092/RealEstate/nha-rieng-pho-ban-to-chuc-quan-uy-cau-giay-dong-cua-im-im_ohou2l.jpg',4),(8,'Trong nhà','https://res.cloudinary.com/fijetso3671/image/upload/v1559872756/RealEstate/20180620142809-644e_c4zz8e.jpg',4),(9,'Nhà bếp','https://gotrangtri.vn/wp-content/uploads/2018/05/thi%E1%BA%BFt-k%E1%BA%BF-n%E1%BB%99i-th%E1%BA%A5t-nh%C3%A0-b%E1%BA%BFp-%C4%91%E1%BA%B9p-c%E1%BA%A7n-c%C3%B3-g%C3%AC.jpg',4),(10,'Mặt trước','http://cafefcdn.com/thumb_w/650/2018/12/6/hinh-1-1544088631382690327544-crop-1544088723594514569302.jpg',5),(11,'Trong nhà','https://res.cloudinary.com/fijetso3671/image/upload/v1559873204/RealEstate/cho-thu%C3%AA-nh%C3%A0-ri%C3%AAng-4-ph%C3%B2ng-ng%E1%BB%A7-t%E1%BA%A1i-%C4%91%E1%BA%B1ng-giang-qu%E1%BA%ADn-ng%C3%B4-quy%E1%BB%81n-h%E1%BA%A3i-ph%C3%B2ng_doolm2.jpg',5),(12,'Nhà bếp','https://nhadepsang.com.vn/images/2018/01/trang-tri-nha-bep-3.png',5),(13,'Mặt trước','http://www.sieuthibds.com/wp-content/uploads/2016/01/ban-nha-rieng-tai-phuong-binh-chuan-600x450.jpg',6),(14,'Trong nhà','https://res.cloudinary.com/fijetso3671/image/upload/v1559873204/RealEstate/uu-diem-cua-can-ho-chung-cu_taiqsx.jpg',6),(15,'Nhà bếp','https://www.giadinhnestle.com.vn/sites/default/files/articles/sliders/cach-trang-tri-nha-bep-theo-phong-thuy-de-dem-lai-may-man-630x350.jpg',6),(16,'Mặt trước','https://nld.mediacdn.vn/thumb_w/540/2018/4/20/123-15241955574791633741019.jpg',1),(17,'Trong nhà','https://res.cloudinary.com/fijetso3671/image/upload/v1559873204/RealEstate/dsc7489_bnlp_kkk8za.jpg',1),(18,'Nhà bếp','http://file.vforum.vn/hinh/2016/10/noi-that-bep-dep-cho-nha-nho-1.jpg',1);
...
CREATE TABLE `request` (
  `id` bigint(20) NOT NULL,
  `email` varchar(255) DEFAULT NULL,
  `higest_price` bigint(20) DEFAULT NULL,
...
INSERT INTO `trade` VALUES (1,40000000000,'Nhà mặt tiền quận 1 thuận tiện kinh doanh',2,1,1,3,1,1),(2,53000000000,'Nhà quận 1 rộng rãi thoáng mát',0,2,2,3,1,2),(3,3800000000,'Bán nhà hẻm xe hơi phường Hiệp Bình Phước, Quận Thủ Đức, hướng Tây',0,3,3,1,2,2),(4,5100000000,'Bán nhà hẻm xe hơi phường Hiệp Bình Phước, Quận Thủ Đức, hướng Tây',0,4,4,2,2,1),(5,3300000000,'Bán nhà riêng quận 5 đang cho thuê 6tr/tháng',0,5,5,3,2,2),(6,3700000000,'Bán nhà riêng quận 5',0,6,6,3,2,1);
...
INSERT INTO `trade_kind` VALUES (1,'Bán'),(2,'Thuê');
...
INSERT INTO `user` VALUES (2,'1997-06-05 00:00:00','danhthanh0605@gmail.com',_binary '\0','Danh Thanh','werf1651','0123456789',2,_binary '\0'),(3,'1991-11-30 11:57:24','152032545@gmail.com',_binary '\0','Lê Thị Thảo Trâm','dfgsfgsdfg','0123456789',NULL,_binary '\0'),(8,NULL,'henrynguyen02081997@gmail.com',_binary '\0','Nguyễn Thị Ngọc Huyền',NULL,NULL,NULL,_binary ''),(7,NULL,'15520325@gm.uit.edu.vn',_binary '\0','HUYỀN NGUYỄN THỊ NGỌC',NULL,NULL,NULL,_binary ''),(12,NULL,'jessicakelny02081997@gmail.com',_binary '\0','Jessica','$2a$10$6JSBBfIfsZkf6V5ETitYROnvQz.Uz7z7YscjCB8IBnmqBWrc6XpUa','0123456789',NULL,_binary '');
...
INSERT INTO `user_kind` VALUES (1,'Chủ nhà'),(2,'Môi giới');
...
INSERT INTO `user_role` VALUES (2,2),(8,2),(9,2),(12,2);
...
-- Dump completed on 2019-10-10 10:01:58
